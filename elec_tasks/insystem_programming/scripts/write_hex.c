...
int main(){
	...
	ispSetSCKOption(USBASP_ISP_SCK_AUTO); //set sck period for communication between programeer and the target
    ...
    fp = fopen("~/project_repositories/advitiya/elec_tasks/insystem_programming/scripts/led.hex", "r"); // error check this!
